...
const translations = {
  en: {
    siteTitle: 'Mildo AI — 170+ Agents. 6 Business Units. One Agri-Food Tech Group.',
    siteDesc: 'Mildo AI — An Agri-Food Tech holding group run by 170+ AI agents. Smart farm, digital products, R&D, AI consulting, and trading — all orchestrated by a self-improving agent system.',
    nav: {
      ventures: 'Group', products: 'Portfolio', services: 'Services',
      work: 'Case Studies', contact: 'Contact', cta: "Let's Talk",
    },
    hero: {
      tagline: '170+ AI agents running an Agri-Food Tech group.',
      sub: 'Smart farm · digital products · robotics R&D · AI consulting — one self-improving holding group.',
      highlight: '170+ agents. 18 projects. 4 LLM tiers. Self-evolving architecture.',
      cta1: 'Book a consultation', cta2: 'View portfolio',
      stats: [
        { value: '170+', label: 'AI Agents' },
    ...
    ventures: {
      ...
      items: [
        ...
        },
        {
          ...
          tagline: 'SubSwap · CropCast · Chef\'s · Pour & Pair · Brain for Art · Hidden Japan · CruisePick · Myoun',
          description: 'Eight AI-native digital products spanning food intelligence, travel tech, and art knowledge. Each runs on Neo4j knowledge graphs, multi-agent content pipelines, and zero-cost infra.',
          metrics: ['8 live/building products', '3 Neo4j knowledge graphs', '$0 infra SaaS'],
        },
        {
          statusLabel: 'R&D',
          name: 'R&D Institute',
        ...
        },
        {
          ...
          description: 'Design and build multi-agent systems for enterprises. The Mildo Group itself is the living reference case — 170+ agents across 6 BUs, RALPH loops, DGM-H self-improvement, 4-tier LLM routing.',
    ...
    products: {
      label: '// portfolio', title: '18 Projects in the Portfolio',
      ...
      items: [
        ...
        },
        {
          ...
          description: 'CIDOC CRM ontology with 432K+ nodes. Art knowledge graph for curators, gallerists, and collectors. MCP-powered search.',
        },
        {
        ...
        },
        {
          ...
          description: 'DGM-H inspired unified agent management. Profile-based installer deploys 170+ agents to any project in one command.',
        },
        {
        ...
        {
          name: 'Myoun', tagline: 'Saju Fortune Platform + MCP',
          description: 'Korean Saju (Four Pillars) fortune iOS app plus a saju MCP server, open-sourcing June 2026. Manse calendar engine (NASA TT-UT1 + KASI solar terms). Freemium coin economy.',
        },
      ],
    },
    services: {
    ...
    caseStudies: {
      ...
      liveLabel: 'live',
      cases: [
        { subtitle: 'Plugin-style hub deploys 170+ agents across 8+ projects in one command',
        ...
        { subtitle: 'Full-company AI for an Agri-Food Tech group — 170+ agents, 6 BUs',
          description: 'Designed and built an 170+ agent system spanning 6 business units — HQ, Smart Farm, R&D Institute, Digital Products, AI Consulting, and Investment/Trading. Group CEO orchestrates 8 BU directors. RALPH loops enforce quality with Worker → Reviewer → SHIP/REVISE cycles. 4 LLM tiers (Opus/Sonnet/Codex/Haiku) minimize cost. Self-improving via DGM-H launchd loop.',
        ...
        { subtitle: 'AI agents that draft and file real patents — first KIPO filing live',
          description: 'A patent-filing agent system (prior-art search → claims → KIPO-compliant drawings) drafts full specifications. First patent filed 2026-05-27 (App. No. 10-2026-0096233); 8 patents cleared an internal 16/16 quality gate with 103 claims. The AI writes the spec and drawings; a licensed patent attorney reviews and files.',
          metricLabels: ['Patent Filed', 'Quality Gate', 'Claims', 'Drafted By'] },
      ],
    },
  ...
  ko: {
    siteTitle: '밀도 AI — 170+개 AI 에이전트가 운영하는 Agri-Food Tech 그룹',
    siteDesc: '밀도 AI — AI, 데이터, 로봇으로 스마트팜을 운영하고 디지털 제품을 만드는 홀딩 그룹. 170+개 AI 에이전트, 18개 프로젝트, 6개 사업부.',
    nav: {
      ventures: '그룹 구조', products: '포트폴리오', services: '서비스',
      work: '실적', contact: '문의', cta: '상담하기',
    },
    hero: {
      tagline: '170+개 AI 에이전트가 Agri-Food Tech 그룹을 운영합니다.',
      sub: '스마트팜 · 디지털 제품 · 농업 로봇 R&D · AI 컨설팅 — 자기 진화하는 홀딩 그룹.',
      highlight: '170+개 에이전트. 18개 프로젝트. 6개 사업부. 자기개선 아키텍처.',
      cta1: '무료 상담 예약', cta2: '포트폴리오 보기',
      stats: [
        { value: '170+', label: 'AI 에이전트' },
    ...
    ventures: {
      ...
      items: [
        ...
        },
        {
          statusLabel: '운영중',
          name: '디지털사업부 BU',
          tagline: 'SubSwap · CropCast · 셰프어시스턴트 · Pour&Pair · Brain for Art · Hidden Japan · CruisePick · Myoun',
          description: '식재료 인텔리전스, 트래블테크, 아트 지식 등 7개 AI 네이티브 디지털 제품. 각 제품은 Neo4j 지식 그래프, 멀티 에이전트 파이프라인, 무비용 인프라로 운영.',
          metrics: ['8개 운영/개발 프로덕트', '3개 Neo4j 지식 그래프', '$0 인프라 SaaS'],
        },
        {
          statusLabel: 'R&D',
          name: '기술연구소 BU',
        ...
        },
        {
          ...
          description: '기업을 위한 멀티 에이전트 시스템을 설계하고 구축합니다. 밀도 그룹 자체가 살아있는 레퍼런스 케이스 — 6개 BU에 170+개 에이전트, RALPH 루프, DGM-H 자기개선, 4단계 LLM 라우팅.',
    ...
    products: {
      label: '// 포트폴리오', title: '18개 프로젝트 포트폴리오',
      ...
      items: [
        ...
        },
        {
          ...
          description: 'CIDOC CRM 온톨로지, 432K+ 노드. 큐레이터·갤러리스트·컬렉터를 위한 아트 지식 그래프. MCP 검색.',
        },
        {
        ...
        },
        {
          ...
          description: 'DGM-H 영감 통합 에이전트 관리. 프로필 기반 설치로 170+ 에이전트를 어떤 프로젝트에나 명령 하나로 배포.',
        },
        {
        ...
        {
          name: '묘운', tagline: '사주 운세 플랫폼 + MCP',
          description: '한국 명리학 사주 iOS 앱과 사주 MCP 서버(2026년 6월 OSS 공개). 만세력 엔진(NASA TT-UT1 + KASI 절기). 프리미엄 코인 경제.',
        },
      ],
    },
    services: {
    ...
    caseStudies: {
      ...
      liveLabel: '운영중',
      cases: [
        { subtitle: '명령 하나로 170+ 에이전트를 8+ 프로젝트에 배포하는 플러그인 허브',
        ...
        { subtitle: 'Agri-Food Tech 그룹 전사 AI 시스템 — 170+개 에이전트, 6개 BU',
          description: '6개 사업부(본사, 영농법인, 기술연구소, 디지털사업부, AI컨설팅, 투자/트레이딩)에 걸친 170+개 에이전트 시스템 설계 및 구축. 그룹 CEO가 8개 BU장에게 라우팅. RALPH 루프가 Worker→Reviewer→SHIP/REVISE 사이클로 품질 보장. 4단계 LLM 티어(Opus/Sonnet/Codex/Haiku)로 비용 최소화. DGM-H launchd 루프로 자기개선.',
        ...
        { subtitle: '실제 특허를 작성·출원하는 AI 에이전트 — 첫 KIPO 출원 완료',
          description: '특허 출원 에이전트 시스템(선행기술 조사 → 청구항 → KIPO 규격 도면)이 명세서 전문을 작성합니다. 2026-05-27 첫 특허 출원(출원번호 10-2026-0096233), 8건이 내부 16/16 품질 게이트를 103개 청구항으로 통과. AI가 명세서·도면을 쓰고 변리사가 검토·출원합니다.',
          metricLabels: ['출원 특허', '품질 게이트', '청구항', '작성 주체'] },
      ],
    },
  ...
  ja: {
    siteTitle: 'Mildo AI — 170+のAIエージェントが運営するAgri-Food Techグループ',
    ...
    hero: {
      tagline: '170+のAIエージェントがAgri-Food Techグループを運営します。',
      sub: 'スマート農場 · デジタル製品 · 農業ロボットR&D · AIコンサルティング — 自己進化するホールディング。',
      highlight: '170+エージェント。18プロジェクト。6事業部。自己改善アーキテクチャ。',
      cta1: '無料相談を予約', cta2: 'ポートフォリオを見る',
      stats: [
        { value: '170+', label: 'AIエージェント' },
    ...
    ventures: {
      ...
      items: [
        ...
        },
        {
          statusLabel: '稼働中',
          name: 'デジタル事業部BU',
          tagline: 'SubSwap · CropCast · シェフズアシスタント · Pour&Pair · Brain for Art · Hidden Japan · CruisePick · Myoun',
          description: '食品インテリジェンス、トラベルテック、アート知識など7つのAIネイティブデジタル製品。各製品はNeo4jナレッジグラフ、マルチエージェントパイプライン、ゼロコストインフラで運営。',
          metrics: ['8製品運営/開発中', '3つのNeo4j KG', '$0インフラSaaS'],
        },
        {
          statusLabel: 'R&D',
          name: '技術研究所BU',
        ...
        },
        {
          ...
          description: '企業向けマルチエージェントシステムを設計・構築。Mildoグループ自体が生きたリファレンスケース — 6BUに170+エージェント、RALPHループ、DGM-H自己改善、4段階LLMルーティング。',
    ...
    products: {
      label: '// ポートフォリオ', title: '18プロジェクトのポートフォリオ',
      ...
      items: [
        ...
        { name: 'Brain for Art', tagline: 'アートインテリジェンス', description: 'CIDOC CRMオントロジー、432K+ノード。キュレーター向けアートKG。MCP検索。' },
        ...
        { name: 'claude-agents-hub', tagline: 'エージェントハブ', description: 'DGM-H統合エージェント管理。プロファイルベースで170+エージェントを1コマンドで配備。' },
        ...
        { name: '妙運', tagline: '四柱推命プラットフォーム + MCP', description: '韓国四柱推命iOSアプリと四柱MCPサーバー（2026年6月OSS公開）。万歳暦エンジン（NASA TT-UT1 + KASI節気）。フリーミアムコイン経済。' },
      ],
    },
    services: {
    ...
    caseStudies: {
      ...
      liveLabel: '稼働中',
      cases: [
        { subtitle: '1コマンドで170+エージェントを8+プロジェクトに配備するプラグインハブ', description: 'DGM-H inspired統合エージェント管理ハブ。RTK(60-90%トークン削減)、Slack MCP、Obsidian CLI、Codex Plugin統合。週次launchd cronで自律プロンプト改善。', metricLabels: ['エージェント', 'プロジェクト', '統合', 'トークン節約'] },
        { subtitle: 'Agri-Food Techグループ全社AI — 170+エージェント・6BU', description: '6事業部に170+エージェント。グループCEOが8BU長にルーティング。RALPHループが品質保証。4段階LLMティアでコスト最小化。DGM-H launchd自己改善。', metricLabels: ['エージェント', '事業部', 'LLMティア', 'BGエージェント'] },
        ...
        { subtitle: '実際の特許を作成・出願するAIエージェント — 初のKIPO出願完了', description: '特許出願エージェントシステム（先行技術調査→クレーム→KIPO規格図面）が明細書全文を作成。2026-05-27に初特許出願（出願番号10-2026-0096233）、8件が内部16/16品質ゲートを103クレームで通過。AIが明細書・図面を書き、弁理士が確認・出願。', metricLabels: ['出願特許', '品質ゲート', 'クレーム', '作成主体'] },
      ],
    },
  ...
  zh: {
    siteTitle: 'Mildo AI — 170+个AI智能体运营的Agri-Food Tech集团',
    ...
    hero: {
      tagline: '170+个AI智能体运营Agri-Food Tech集团。',
      sub: '智慧农场 · 数字产品 · 农业机器人R&D · AI咨询 — 自我进化的控股集团。',
      highlight: '170+智能体。18个项目。6个业务部门。自我改善架构。',
      cta1: '预约免费咨询', cta2: '查看投资组合',
      stats: [
        { value: '170+', label: 'AI智能体' },
    ...
    ventures: {
      ...
      items: [
        ...
        { statusLabel: '运营中', name: '数字产品BU', tagline: 'SubSwap·CropCast·Chef\'s·Pour&Pair·Brain for Art·Hidden Japan·CruisePick·Myoun', description: '7个AI原生数字产品，涵盖食品智能、旅行科技和艺术知识。每个产品运行在Neo4j知识图谱、多智能体流水线和零成本基础设施上。', metrics: ['8个运营/开发中产品', '3个Neo4j知识图谱', '$0基础设施SaaS'] },
        ...
        { statusLabel: '运营中', name: 'AI咨询BU', tagline: '多智能体系统设计与交付', description: '为企业设计构建多智能体系统。Mildo集团本身就是活生生的参考案例——6个BU中170+个智能体，RALPH循环，DGM-H自我改善，4层LLM路由。', metrics: ['全公司智能体系统', 'RALPH循环质量门', 'mildo-gateway基础设施'] },
    ...
    products: {
      ...
      items: [
        ...
        { name: 'Brain for Art', tagline: '艺术智能平台', description: 'CIDOC CRM本体，432K+节点。策展人艺术KG。MCP搜索。' },
        ...
        { name: 'claude-agents-hub', tagline: '智能体枢纽', description: 'DGM-H统一智能体管理。一键配置文件部署170+智能体。' },
        ...
        { name: '妙运', tagline: '四柱命理平台 + MCP', description: '韩国四柱命理iOS应用和四柱MCP服务器（2026年6月开源）。万年历引擎（NASA TT-UT1 + KASI节气）。免费增值代币经济。' },
      ],
    },
    services: {
    ...
    caseStudies: {
      ...
      liveLabel: '运行中',
      cases: [
        { subtitle: '一键将170+智能体部署到8+项目的插件枢纽', description: 'DGM-H启发的统一智能体管理枢纽。RTK(60-90%令牌节省)、Slack MCP、Obsidian CLI、Codex Plugin集成。周度launchd cron自主提示改善。', metricLabels: ['智能体', '项目', '集成', '令牌节省'] },
        { subtitle: 'Agri-Food Tech集团全公司AI — 170+智能体·6BU', description: '6个业务部门170+智能体。集团CEO路由到8个BU负责人。RALPH循环保证质量。4层LLM成本最小化。DGM-H launchd自我改善。', metricLabels: ['智能体', '业务部门', 'LLM层级', '后台智能体'] },
        ...
        { subtitle: '起草并提交真实专利的AI智能体 — 首次KIPO申请完成', description: '专利申请智能体系统(在先技术检索→权利要求→KIPO规格图纸)起草完整说明书。2026-05-27首次专利申请(申请号10-2026-0096233)，8件通过内部16/16质量门，含103项权利要求。AI撰写说明书和图纸，专利代理人审查并提交。', metricLabels: ['已申请专利', '质量门', '权利要求', '起草者'] },
      ],
    },
  ...
  ar: {
    siteTitle: 'ميلدو AI — 170+ وكيل ذكاء اصطناعي يديرون مجموعة Agri-Food Tech',
    ...
    hero: {
      tagline: '170+ وكيل ذكاء اصطناعي يديرون مجموعة Agri-Food Tech.',
      sub: 'مزرعة ذكية · منتجات رقمية · R&D روبوتات · استشارات AI — مجموعة قابضة ذاتية التطور.',
      highlight: '170+ وكيل. 18 مشروع. 6 وحدات أعمال. بنية ذاتية التحسين.',
      cta1: 'احجز استشارة مجانية', cta2: 'عرض المحفظة',
      stats: [
        { value: '170+', label: 'وكيل AI' },
    ...
    ventures: {
      ...
      items: [
        ...
        { statusLabel: 'نشط', name: 'وحدة المنتجات الرقمية', tagline: 'SubSwap · CropCast · Chef\'s · Pour&Pair · Brain for Art · Hidden Japan · CruisePick · Myoun', description: '7 منتجات رقمية AI أصلية تغطي ذكاء الغذاء، تقنية السفر، ومعرفة الفن. كل منتج يعمل على رسوم بيانية Neo4j، خطوط أنابيب متعددة الوكلاء، وبنية تحتية بتكلفة صفر.', metrics: ['8 منتجات نشطة/قيد التطوير', '3 رسوم بيانية Neo4j', '$0 بنية SaaS'] },
        ...
        { statusLabel: 'نشط', name: 'وحدة استشارات AI', tagline: 'تصميم وتسليم أنظمة متعددة الوكلاء', description: 'تصميم وبناء أنظمة متعددة الوكلاء للمؤسسات. مجموعة ميلدو ذاتها هي حالة المرجع الحية — 170+ وكيلاً في 6 وحدات، حلقات RALPH، DGM-H التحسين الذاتي.', metrics: ['أنظمة وكلاء كاملة', 'بوابات جودة RALPH', 'بنية mildo-gateway'] },
    ...
    products: {
      label: '// المحفظة', title: 'محفظة 18 مشروعاً',
      ...
      items: [
        ...
        { name: 'Brain for Art', tagline: 'ذكاء الفن', description: 'CIDOC CRM، 432K+ عقدة. KG الفن للمنظمين والمجمعين.' },
        ...
        { name: 'claude-agents-hub', tagline: 'مركز الوكلاء', description: 'إدارة موحدة مستلهمة من DGM-H. نشر 170+ وكيل بأمر واحد.' },
        ...
        { name: 'ميون (妙運)', tagline: 'منصة الطالع + MCP', description: 'تطبيق iOS للطالع الكوري (الأركان الأربعة) وخادم MCP، مفتوح المصدر يونيو 2026. محرك التقويم (NASA TT-UT1 + KASI). اقتصاد عملات مجاني.' },
      ],
    },
    services: {
    ...
    caseStudies: {
      ...
      liveLabel: 'مباشر',
      cases: [
        { subtitle: 'مركز يوزّع 170+ وكيل على 8+ مشاريع بأمر واحد', description: 'مركز موحد مستلهم من DGM-H. RTK (60-90% توفير رموز)، Slack MCP، Obsidian CLI، Codex Plugin. cron launchd أسبوعي للتحسين الذاتي.', metricLabels: ['وكلاء', 'مشاريع', 'تكاملات', 'توفير الرموز'] },
        { subtitle: 'AI كامل مجموعة Agri-Food Tech — 170+ وكيل·6 وحدات', description: '170+ وكيلاً في 6 وحدات. CEO المجموعة يوجه 8 مديري وحدات. حلقات RALPH للجودة. 4 مستويات LLM لتقليل التكلفة. DGM-H التحسين الذاتي.', metricLabels: ['وكلاء', 'وحدات', 'مستويات LLM', 'وكلاء خلفية'] },
        ...
        { subtitle: 'وكلاء AI يصيغون ويودعون براءات حقيقية — أول إيداع KIPO مكتمل', description: 'نظام وكلاء إيداع البراءات (بحث التقنية السابقة → المطالبات → رسومات KIPO) يصيغ المواصفات الكاملة. أول براءة أودعت 2026-05-27 (رقم 10-2026-0096233)؛ 8 براءات اجتازت بوابة جودة داخلية 16/16 بـ103 مطالبة. الذكاء الاصطناعي يكتب المواصفات والرسومات، ووكيل براءات مرخص يراجع ويودع.', metricLabels: ['براءة مودعة', 'بوابة الجودة', 'مطالبات', 'صاغها'] },
      ],
    },
